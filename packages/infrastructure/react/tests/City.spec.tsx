...
class CityComponentBuilder {
    ...
    async build() {
        const controllerFactory = { build: (_: string) => this.controller } as CityControllerFactory
        const screen = render(<City cityControllerFactory={controllerFactory} id={'Grenoble'}/>, { wrapper: MemoryRouter })
